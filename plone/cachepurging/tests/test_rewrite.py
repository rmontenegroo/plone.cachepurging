...
class TestRewrite(unittest.TestCase):
    ...
    def test_no_registry(self):
        ...
        self.assertEquals(['/foo'], self.rewriter('/foo'))
    ...
    def test_standard_vhm(self):
        ...
        self._prepareVHMRequest('/foo')
        self.assertEquals(['/VirtualHostBase/http/example.com/plone/VirtualHostRoot/foo'],
                          self.rewriter('/foo'))
    ...
    def test_virtual_root_is_deep(self):
        ...
        self.assertEquals(['/VirtualHostBase/http/example.com/bar/plone/VirtualHostRoot/foo'],
                          self.rewriter('/foo'))
    ...
    def test_virtual_path_is_root(self):
        ...
        self.assertEquals(['/VirtualHostBase/http/example.com/plone/VirtualHostRoot/'],
                          self.rewriter('/'))
    ...
    def test_virtual_path_is_deep(self):
        ...
        self.assertEquals(['/VirtualHostBase/http/example.com/plone/VirtualHostRoot/foo/bar'],
    ...
    def test_nonstandard_port(self):
        ...
        self.assertEquals(['/VirtualHostBase/http/example.com:81/plone/VirtualHostRoot/foo'],
                          self.rewriter('/foo'))
    ...
    def test_https(self):
        ...
        self.assertEquals(['/VirtualHostBase/https/example.com:81/plone/VirtualHostRoot/foo'],
                          self.rewriter('/foo'))
